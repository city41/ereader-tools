...
exports.MarkCommandSetGenerator = void 0;
const J_LENGTH = 104;
class MarkCommandSetGenerator {
    ...
    calcAddr(address) {
        ...
        if (this.addr[0] >> 10 == address && address != 0)
    ...
    drawAddressBar(dotcodeblock, address) {
        ...
        for (let i = 0; i < dotCodeLength; i++) {
            for (let j = 0; j < 3; j++)
                for (let k = 0; k < 26; k++, count++) {
                    if ((this._810mod[i][Math.floor(count / 8)] >> (7 - (count % 8))) &
                        0x01)
...
exports.MarkCommandSetGenerator = MarkCommandSetGenerator;
MarkCommandSetGenerator.modtable = [
    0x00, //00000
    0x01, //00001
    0x02, //00010
    0x12, //10010
...
//# sourceMappingURL=MarkCommandSetGenerator.js.map