...
exports.clear_dcs = clear_dcs;
exports.init_dcs = init_dcs;
exports.eight_ten_modulate = eight_ten_modulate;
exports.make_dcs = make_dcs;
exports.makebmp = makebmp;
exports.write_bmp = write_bmp;
exports.getDotcodelen = getDotcodelen;
exports.setDotcodelen = setDotcodelen;
exports.getBmplen = getBmplen;
exports.setBmplen = setBmplen;
exports.setRaw = setRaw;
exports.getDpiMultiplier = getDpiMultiplier;
exports.setDpiMultiplier = setDpiMultiplier;
let raw = null;
const dcsbmp = new Array(7912).fill(null).map(() => {
    return new Array(352);
});
const _810mod = new Array(28).fill(null).map(() => {
...
function draw_address_bar(dotcodeblock, address) {
    ...
    for (let i = 0; i < 16; i++ //Render the A pixels and E pixels.  (A = Address, E = Error correction info.)
    ) {
...
function init_dcs() {
    ...
    for (let j = 0; j < dotcodelen; j++) {
        ...
        for (let i = 0; i <= 5; i++ //Render the Z pixels. (
        ) {
...
function setDotcodelen(dcl) {
    dotcodelen = dcl;
}
function getBmplen() {
    return bmplen;
}
function setBmplen(bl) {
    bmplen = bl;
}
function setRaw(r) {
    raw = r;
